...
from .quadruped_marl_env_cfg import QuadrupedMarlEnvCfg


class QuadrupedMarlEnv(DirectMARLEnv):
    cfg: QuadrupedMarlEnvCfg

    def __init__(self, cfg: QuadrupedMarlEnvCfg, render_mode: str | None = None, **kwargs):
